...
//https://www.hamamatsu.com/resources/pdf/etd/PMT_handbook_v3aE-Chapter4.pdf
  const G4int nEntries_tran = 19;
  static double PhotonEnergy_tran[nEntries_tran] = {0.300844802	*eV,
0.300835123	*eV,
0.300903681	*eV,
0.301189201	*eV,
0.301213397	*eV,
...
0.395487512	*eV,
0.403277215	*eV};
  static double transIndex[nEntries_tran] = {0	,
0.061068	,
0.156707	,
0.076087	,
0.104825	,
...
0.95	};
  ...
  table->AddProperty("TRANSMITTANCE", PhotonEnergy_tran, transIndex, nEntries_tran);
...
*/
 ...
 //dream paper
  ...
  G4double Absorption[nEntries_ABS] = {0*cm, 0.02*cm, 2.01*cm, 4*cm, 4.023302971 * cm, 4.255916788 * cm,4.523924776 * cm,4.815007415 * cm,5.160917405 * cm,5.560374547 * cm,6.651855202 * cm,
7.330625889 * cm,8.593280055 * cm,9.708078092 * cm,11.15523627 * cm,13.0145633 * cm,15.48275221 * cm,18.70837387 * cm,21.38077014 * cm,23.02555837 * cm,23.63172323 * cm,23.9469336 * cm,
23.9469336 * cm,24.27007742 * cm,24.94449849 * cm,24.94449849 * cm,25.29596276 * cm,25.29596276 * cm,25.65681445 * cm,25.65681445 * cm,25.65681445 * cm,25.65681445 * cm,25.65681445 * cm,26.41170567 * cm, 26.41170567 * cm};
  G4double PhotonEnergy_ABS[nEntries_ABS] ={3.5*eV, 3.44401*eV, 3.41084*eV, 3.37832*eV, 3.376604418 * eV,3.370894244 * eV,3.365833707 * eV,3.358266778 * eV,3.353244055 * eV,3.345733565 * eV,3.330813064 * eV,3.320945706 * eV,3.303804576 * eV,3.2868482 * eV,3.270064988 * eV,3.246373208 * eV,3.220719845 * eV,3.186369517 * eV,3.13949987 * eV,3.089725278 * eV,3.037376425 * eV,2.986779095 * eV,2.937832906 * eV,2.892332871 * eV,2.846415974 * eV,2.801927859 * eV,2.758815138 * eV,2.717003092 * eV,2.678040871 * eV,2.638629504 * eV,2.600355854 * eV,2.563181955 * eV,2.52705078 * eV,2.491924071 * eV, 1*eV};
double mul=0.5;
for (int ij=0;ij<nEntries_ABS;ij++){
Absorption[ij]*=mul;
}
...
G4double PhotonEnergy_ABS[nEntries_ABS] ={3.5*eV,1*eV};
*/
  const G4int nEntries_SCY = 12;
  G4double ElectronEnergy_SCY[nEntries_SCY] =
      {0.000 * MeV, 0.015 * MeV, 0.020 * MeV, 0.030 * MeV,
